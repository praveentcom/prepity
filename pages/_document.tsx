  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:image" content={`${process.env.NEXT_PUBLIC_BASE_URL}/images/common/prepity_og.png`} />
        ...
        <meta name="twitter:image" content={`${process.env.NEXT_PUBLIC_BASE_URL}/images/common/prepity_og.png`} />
